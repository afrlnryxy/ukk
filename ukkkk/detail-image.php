...
<body>
    ...
    <div class="col-7">
        <form method="post">
            <?php
            $qt = mysqli_query($conn, "SELECT SUM(suka) FROM likefoto WHERE foto_id = '".$_GET['id']."' ");
        ...
        <div class="content">
            <form action="" method="post">
                ...
                <textarea name="komentar" type="text" class="input-control" maxlength="300" placeholder="Tulis komentar" required></textarea>
